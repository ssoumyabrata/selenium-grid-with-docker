...
public class DockerChromeTest {
    ...
    public void setUp() throws MalformedURLException {
        ...
        try {
            ...
            logger.info("Connected to Remote Chrome via Selenium Grid");
        } catch (Exception e) {
    ...
    public void testGoogleSearchDocker() {
        try {
            logger.info("Starting Google search test on Docker Chrome");
    ...
    public void testPageNavigationDocker() {
        try {
            logger.info("Starting page navigation test on Docker Chrome");
