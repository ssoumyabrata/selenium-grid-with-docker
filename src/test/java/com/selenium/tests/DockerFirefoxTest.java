...
/**
 * Selenium test class for Docker Firefox container
 */
public class DockerFirefoxTest {
    private static final Logger logger = LoggerFactory.getLogger(DockerFirefoxTest.class);
    private WebDriver driver;

    @BeforeClass
    public void setUp() throws MalformedURLException {
        logger.info("Setting up RemoteWebDriver for Docker Firefox");
        try {
            ...
            logger.info("Connected to Remote Firefox via Selenium Grid");
        } catch (Exception e) {
    ...
    public void testGoogleSearchDocker() {
        try {
            logger.info("Starting Google search test on Docker Firefox");
    ...
    public void testPageNavigationDocker() {
        try {
            logger.info("Starting page navigation test on Docker Firefox");
